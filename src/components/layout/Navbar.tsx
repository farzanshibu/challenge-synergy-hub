            ...
            <div className="flex items-center gap-4">
                    ...
                    <Toggle
                      ...
                      className={cn(
                        ...
                        isModernUI ? 'bg-gradient-to-r from-amber-500/70 to-amber-300/20 text-black shadow-lg' : 'hover:bg-zinc-800 hover:shadow-md',
                        'cursor-pointer'
                      )}
                      ...
                      {user?.user_metadata?.avatar_url ? (
                        ...
                        <AvatarFallback className="bg-accent/20 text-accent">
                          {user?.user_metadata?.name ? 
                            <p>{user?.user_metadata?.name?.split(' ').map(name => name.charAt(0)).join('')}</p> :
