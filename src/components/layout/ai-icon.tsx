...
const SparklingStars = ({ color = '#94A3B8' }) => {
  return (
    <div className="mr-3">
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Define gradients */}
          <defs>
            {/* Linear gradient for the stars: blue to white */}
            <linearGradient id="starGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style={{ stopColor: 'blue', stopOpacity: 1 }} />
              <stop offset="100%" style={{ stopColor: 'white', stopOpacity: 1 }} />
            </linearGradient>
            {/* Radial gradient for the sparkles: white to transparent */}
            <radialGradient id="sparkleGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
              <stop offset="0%" style={{ stopColor: 'white', stopOpacity: 1 }} />
              <stop offset="100%" style={{ stopColor: 'white', stopOpacity: 0 }} />
            </radialGradient>
          </defs>
          {/* Star paths with blue-to-white gradient */}
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            fill={color}
          />
          {/* Sparkle circles with animation */}
          <circle cx="9" cy="12" r="1.5" fill="url(#sparkleGradient)">
            <animate attributeName="opacity" values="0;1;0" dur="2s" repeatCount="indefinite" />
          </circle>
          <circle cx="18" cy="6" r="1" fill="url(#sparkleGradient)">
            <animate attributeName="opacity" values="0;1;0" dur="1.5s" repeatCount="indefinite" />
          </circle>
          <circle cx="16.5" cy="18.75" r="1.2" fill="url(#sparkleGradient)">
