          ...
          <div className="p-6">
            ...
            <Tabs defaultValue="challenges" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-6 bg-zinc-800/50 border border-zinc-800">
                <TabsTrigger value="challenges" className="data-[state=active]:bg-zinc-800">Challenges</TabsTrigger>
                <TabsTrigger value="create" className="data-[state=active]:bg-zinc-800">Create</TabsTrigger>
                <TabsTrigger value="manage" className="data-[state=active]:bg-zinc-800">Manage</TabsTrigger>
              </TabsList>
